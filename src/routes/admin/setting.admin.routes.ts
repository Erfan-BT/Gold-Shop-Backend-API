...
import { changeSettingSchema, createSettingSchema, settingIdSchema, settingQS } from '../../validation/setting.validation.js'

const router = express.Router()

router.get('/', validate({ query : settingQS }), adminSettingController.getAllSettings)
