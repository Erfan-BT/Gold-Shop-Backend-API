...
import { changeVariantPricingSchema, createVariantPricingSchema, productVariantPricingIds } from '../../validation/pricing.validation.js'

const router = express.Router()

router.get('/', validate({ params : productVariantIdsSchema }), adminPricingController.getVariantPricing)
router.post('/', validate({ params : productVariantIdsSchema, body : createVariantPricingSchema }), adminPricingController.createVariantPricing)
router.patch('/:pricingId', validate({ params : productVariantPricingIds , body : changeVariantPricingSchema }), adminPricingController.changeVariantPricing)
