...
router.get('/addresses/:id', authMiddleware, validate({ params : addressIdSchema }), usersController.userAddressById)
router.post('/addresses', authMiddleware, validate({ body : addressSchema }), usersController.createAddress)
router.patch('/addresses/:id', authMiddleware, validate({ body : addressSchema , params : addressIdSchema}), usersController.updateAddressInfo)
router.patch('/addresses/:id/default', authMiddleware, validate({ params : addressIdSchema}), usersController.setDefaultAddress)
router.delete('/addresses/:id', authMiddleware, validate({ params : addressIdSchema }), usersController.deleteAddress)
