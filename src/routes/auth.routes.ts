...
router.get('/verify-email/confirm/:token', validate({ params : otpSchema }), authController.verifyEmailConfirm)
...
router.post('/reset-password/:token', validate({ params : otpSchema, body : passwordSchema }), authController.resetPassword)
